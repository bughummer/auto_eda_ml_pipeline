      ...
      {data && (
        <>
          ...
          <Tabs
            ...
            items={[
              { key: 'eda', label: 'EDA', children: <EdaTab experimentId={experimentId} /> },
              {
                key: 'features',
                label: 'Feature review',
                children: <FeatureReviewTab experimentId={experimentId} />,
              },
              { key: 'training', label: 'Training', children: <TrainingTab experimentId={experimentId} /> },
              {
                key: 'comparison',
                label: 'Comparison',
                children: <ComparisonTab experimentId={experimentId} />,
              },
              {
                key: 'reasoning',
